...
#JAVA_OPTS="-Xms1028m -Xmx1028m -Xss256k -Xmn512M -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:-UseGCOverheadLimit -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005"

#JAVA_OPTS="-Xms1024m -Xmx2048m -Xss256k -Xmn512M -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:-UseGCOverheadLimit"
